...
# ==========================================
# 2. STRICT NSE F&O TICKER WATCHLIST (~180 STOCKS)
# ==========================================

def get_fno_watchlist() -> list:
    """Returns the full list of active NSE F&O stocks formatted for yfinance."""
    fno_list = [
        ...
        "JUBLFOOD", "KOTAKBANK", "LALPATHLAB", "LT", "LTIM", "LTF", "LTTS", "LUPIN",
